...
import 'package:sign_lang_app/alphabets/alphabet.dart';
import 'package:sign_lang_app/comparison/islcomalp.dart';
import 'package:sign_lang_app/comparison/islcomnum.dart';
import 'package:sign_lang_app/detect/cam.dart';
import 'package:sign_lang_app/isl_dd.dart';
import 'package:sign_lang_app/links.dart';
import 'package:sign_lang_app/numbers/number.dart';
import 'package:sign_lang_app/quiz/alphabet.dart';
import 'package:sign_lang_app/quiz/mainq.dart';
...
class _HomePageState extends State<HomePage> {
  /*loadmodel() async {
    Tflite.loadModel(
      model: "assets/model/isl/model_unquant.tflite",
      labels: "assets/model/isl/labels.txt",
    );
  }*/
  int selectedPage = 0;
    ...
    return Scaffold(
      /*floatingActionButton: Container(
        ...
        child: TextButton(
          ...
          onPressed: (){Navigator.push(context, MaterialPageRoute(builder: (context) => Cam()));},
        ),
      ),*/
      appBar: AppBar(
        actions: [
                        ...
                        builder: (BuildContext context){
                          return SimpleDialog(
                            ...
                            children: [
                              TextButton(
                                onPressed: () {
                                  Navigator.push(context,MaterialPageRoute(builder: (context) => IslComAlp()));
                                },
                                child: Row(
                                  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                                  children: [
                              ...
                              TextButton(
                                onPressed: () {
                                  Navigator.push(context,MaterialPageRoute(builder: (context) => IslComNum()));
                                },
                                child: Row(
                                  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                                  children: [
        ...
        title: Text('ISL',style: GoogleFonts.nunito(
          fontWeight: FontWeight.w700,
          fontSize: 22,
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: <BottomNavigationBarItem>[
          ...
          BottomNavigationBarItem(
            label: 'Basics',
            icon: Icon(Icons.insights_sharp,size: 25,),
          ),
          BottomNavigationBarItem(
            label: 'Practice',
